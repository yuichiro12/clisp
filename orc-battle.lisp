...
(defun game-loop ()
  (unless (or (player-dead) (monsters-dead))
    ...
    (map 'list
	 (lambda (m)
	   (or (monster-dead m) (monster-attack m))) ;; orは1つでもtと評価された時点で評価を中止する
	 *monsters*)
    (game-loop)))
...
(defun player-attack ()
  (fresh-line)
  (princ "Attack style: [s]tab [d]owble swing [r]oundhouse:")
  (case (read)
    ...
    (otherwise (progn (princ "Command doesn't exist.") (player-attack)))))
